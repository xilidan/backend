...
// IsReviewer applies equality check predicate on the "is_reviewer" field. It's identical to IsReviewerEQ.
func IsReviewer(v bool) predicate.Position {
	return predicate.Position(sql.FieldEQ(FieldIsReviewer, v))
}
...
// IsReviewerEQ applies the EQ predicate on the "is_reviewer" field.
func IsReviewerEQ(v bool) predicate.Position {
	return predicate.Position(sql.FieldEQ(FieldIsReviewer, v))
}

// IsReviewerNEQ applies the NEQ predicate on the "is_reviewer" field.
func IsReviewerNEQ(v bool) predicate.Position {
	return predicate.Position(sql.FieldNEQ(FieldIsReviewer, v))
}
