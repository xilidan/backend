#!/usr/bin/env python3
"""
Script to properly update service.py with dueDate support and sprint auto-assignment.
This script makes all necessary changes in the correct locations.
"""
...
def apply_changes():
    ...
    # Change 1: Update create_task signature
    ...
    # Change 2: Add dueDate to payload
    content = content.replace(
    ...
    # Change 3: Update create_jira_tasks beginning
    content = content.replace(
    ...
    # Change 4: Update task creation to collect keys
    content = content.replace(
        """                jira_res = None
                if item_type == 'Epic':
    ...
    # Change 5: Update story creation
    content = content.replace(
        """                        # Create Story/Task
    ...
    # Change 6: Update end of create_jira_tasks
    content = content.replace(
        """                
        print("\\n" + "="*80)
    ...
    # Change 7: Add helper methods before analyze_transcription
    helper_methods = '''
...
'''
    ...
    # Insert helper methods before analyze_transcription
    ...
    print("✅ Successfully updated service.py with all changes")
    print("   - Added due_date parameter to create_task")
    print("   - Added dueDate to payload")
    print("   - Added active sprint fetching")
    print("   - Added issue key collection")
    print("   - Added sprint assignment at end")
